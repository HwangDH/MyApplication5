...
public class UROGraph extends AppCompatActivity {

    private LineChart lineChart;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_urograph);
        ...
        Button button2 = (Button) findViewById(R.id.ProActivity);
        ...
        // json 연동
        String test = "https://scv0319.cafe24.com/man/getURO.php";
        ...
        try {
            ...
            for (int i = 0; i < ja.length(); i++) {
                ...
                int uro = week.getInt("URO");
                yAXES.add(new Entry(uro, i));
        ...
        //아래 그림의 파란색 그래프
        LineDataSet lineDataSet = new LineDataSet(yAXES, "URO");
