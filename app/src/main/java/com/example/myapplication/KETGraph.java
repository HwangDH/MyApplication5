...
public class KETGraph extends AppCompatActivity {

    private LineChart lineChart;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ketgraph);

        Button button = (Button) findViewById(R.id.LeuActivity);
        ...
        Button button2 = (Button) findViewById(R.id.GluActivity);
        ...
        // json 연동
        String test = "https://scv0319.cafe24.com/man/getKET.php";
        ...
        try {
            ...
            for (int i = 0; i < ja.length(); i++) {
                ...
                int ket = week.getInt("KET");
                yAXES.add(new Entry(ket, i));
        ...
        //아래 그림의 파란색 그래프
        LineDataSet lineDataSet = new LineDataSet(yAXES, "KET");
